...
CREATE TABLE `smbms_address` (
  ...
  `address_Desc` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '收货地址明细',
  `post_Code` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '邮编',
...
insert  into `smbms_address`(`id`,`contact`,`address_Desc`,`post_Code`,`tel`,`created_By`,`creation_Date`,`modify_By`,`modify_Date`,`user_Id`) values 
...
CREATE TABLE `smbms_bill` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `bill_Code` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '账单编码',
  `product_Name` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '商品名称',
  `product_Desc` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '商品描述',
  `product_Unit` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '商品单位',
  `product_Count` decimal(20,2) DEFAULT NULL COMMENT '商品数量',
  `total_Price` decimal(20,2) DEFAULT NULL COMMENT '商品总额',
  `is_Payment` int(10) DEFAULT NULL COMMENT '是否支付（1：未支付 2：已支付）',
  `created_By` bigint(20) DEFAULT NULL COMMENT '创建者（userId）',
  `creation_Date` datetime DEFAULT NULL COMMENT '创建时间',
  `modify_By` bigint(20) DEFAULT NULL COMMENT '更新者（userId）',
...
insert  into `smbms_bill`(`id`,`bill_Code`,`product_Name`,`product_Desc`,`product_Unit`,`product_Count`,`total_Price`,`is_Payment`,`created_By`,`creation_Date`,`modify_By`,`modify_Date`,`provider_Id`) values 
...
CREATE TABLE `smbms_provider` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `pro_Code` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '供应商编码',
  `pro_Name` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '供应商名称',
  `pro_Desc` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '供应商详细描述',
  `pro_Contact` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '供应商联系人',
  `pro_Phone` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '联系电话',
  `pro_Address` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '地址',
  `pro_Fax` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '传真',
  `created_By` bigint(20) DEFAULT NULL COMMENT '创建者（userId）',
  `creation_Date` datetime DEFAULT NULL COMMENT '创建时间',
  `modify_Date` datetime DEFAULT NULL COMMENT '更新时间',
  `modify_By` bigint(20) DEFAULT NULL COMMENT '更新者（userId）',
...
insert  into `smbms_provider`(`id`,`pro_Code`,`pro_Name`,`pro_Desc`,`pro_Contact`,`pro_Phone`,`pro_Address`,`pro_Fax`,`created_By`,`creation_Date`,`modify_Date`,`modify_By`) values 
...
CREATE TABLE `smbms_role` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `role_Code` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '角色编码',
  `role_Name` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '角色名称',
  `created_By` bigint(20) DEFAULT NULL COMMENT '创建者',
  `creation_Date` datetime DEFAULT NULL COMMENT '创建时间',
  `modify_By` bigint(20) DEFAULT NULL COMMENT '修改者',
  `modify_Date` datetime DEFAULT NULL COMMENT '修改时间',
...
insert  into `smbms_role`(`id`,`role_Code`,`role_Name`,`created_By`,`creation_Date`,`modify_By`,`modify_Date`) values 
...
CREATE TABLE `smbms_user` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_Code` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '用户编码',
  `user_Name` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '用户名称',
  `user_Password` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '用户密码',
  `gender` int(10) DEFAULT NULL COMMENT '性别（1:女、 2:男）',
  `birthday` date DEFAULT NULL COMMENT '出生日期',
  `phone` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '手机',
  `address` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '地址',
  `user_Role` bigint(20) DEFAULT NULL COMMENT '用户角色（取自角色表-角色id）',
  `created_By` bigint(20) DEFAULT NULL COMMENT '创建者（userId）',
  `creation_Date` datetime DEFAULT NULL COMMENT '创建时间',
  `modify_By` bigint(20) DEFAULT NULL COMMENT '更新者（userId）',
  `modify_Date` datetime DEFAULT NULL COMMENT '更新时间',
...
insert  into `smbms_user`(`id`,`user_Code`,`user_Name`,`user_Password`,`gender`,`birthday`,`phone`,`address`,`user_Role`,`created_By`,`creation_Date`,`modify_By`,`modify_Date`) values 
(1,'admin','超级系统管理员','121121',1,'1983-10-10','13688889999','北京市海淀区成府路207号',1,1,'2013-03-21 16:52:07',NULL,NULL),
...
(11,'345345','肚子里面','0000000',2,'1978-03-12','13367890900','北京市朝阳区建国门南大街10号',3,1,'2016-11-09 16:51:17',NULL,NULL),

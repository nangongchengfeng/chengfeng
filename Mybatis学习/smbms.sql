...
CREATE TABLE `smbms_address`  (
  ...
  `address_Desc` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '收货地址明细',
  `post_Code` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '邮编',
...
CREATE TABLE `smbms_bill`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `bill_Code` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '账单编码',
  `product_Name` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '商品名称',
  `product_Desc` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '商品描述',
  `product_Unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '商品单位',
  `product_Count` decimal(20, 2) NULL DEFAULT NULL COMMENT '商品数量',
  `total_Price` decimal(20, 2) NULL DEFAULT NULL COMMENT '商品总额',
  `is_Payment` int(10) NULL DEFAULT NULL COMMENT '是否支付（1：未支付 2：已支付）',
  `created_By` bigint(20) NULL DEFAULT NULL COMMENT '创建者（userId）',
  `creation_Date` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `modify_By` bigint(20) NULL DEFAULT NULL COMMENT '更新者（userId）',
...
INSERT INTO `smbms_bill` VALUES (12, 'BILL2016_012', '芝华士', '饮料-洋酒', '瓶', 20.00, 6000.00, 2, 1, '2016-09-09 17:00:00', NULL, NULL, 2);
...
CREATE TABLE `smbms_provider`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `pro_Code` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '供应商编码',
  `pro_Name` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '供应商名称',
  `pro_Desc` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '供应商详细描述',
  `pro_Contact` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '供应商联系人',
  `pro_Phone` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '联系电话',
  `pro_Address` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '地址',
  `pro_Fax` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '传真',
  `created_By` bigint(20) NULL DEFAULT NULL COMMENT '创建者（userId）',
  `creation_Date` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `modify_Date` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `modify_By` bigint(20) NULL DEFAULT NULL COMMENT '更新者（userId）',
...
CREATE TABLE `smbms_role`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `role_Code` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '角色编码',
  `role_Name` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '角色名称',
  `created_By` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
  `creation_Date` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `modify_By` bigint(20) NULL DEFAULT NULL COMMENT '修改者',
  `modify_Date` datetime NULL DEFAULT NULL COMMENT '修改时间',
...
CREATE TABLE `smbms_user`  (
  ...
  `user_Password` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '用户密码',
...
-- ----------------------------
INSERT INTO `smbms_user` VALUES (1, 'admin', '系统管理', 'admin', 1, '1983-10-10', '13688889999', '北京市海淀区成府路207号', 1, 1, '2013-03-21 16:52:07', NULL, NULL);
